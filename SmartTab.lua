--[[
    Smart Tab Library v5
    - Seleção corrigida
    - PageView com transparência do menu Roblox
    - Suporte a PageScrolling
]]
...
local function createTab(hubBarContainer, page, config)
    ...
    if pageViewInner then
        ...
        local useScrolling = config.PageScrolling == true or config.PageScrolling == "yes" or config.PageScrolling == "Yes"

        local contentParent = myPageView
        ...
        if useScrolling then
            ...
            scrollFrame.CanvasSize = UDim2.new(0, 0, 0, config.ScrollSize or 800)
        ...
        -- Frame principal com transparência do menu Roblox
        local contentFrame = Instance.new("Frame")
        contentFrame.Name = "Content"
        contentFrame.Size = UDim2.new(1, -24, 0, useScrolling and (config.ScrollSize or 800) or 400)
        contentFrame.Position = UDim2.new(0, 12, 0, 12)
        contentFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        contentFrame.BackgroundTransparency = 0.3 -- mesma transparência do MenuContainer
        contentFrame.BorderSizePixel = 0
        contentFrame.Parent = contentParent
...
function Tab(data)
    ...
    local config = {
        ...
        PageScrolling = data.PageScrolling or false,
        ScrollSize = data.ScrollSize or 800
    }
